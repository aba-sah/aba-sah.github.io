...
to uncover and tell stories contained within data, to:  
  ...
  * track and explore evolving trends, as for [_pupil_](https://www.dtecharter.org/subject-statistics) and [_teacher_](https://www.dtecharter.org/teacher-statistics) demographics in Scotland, working with [__dressCode__](https://www.dresscode.org.uk/scotlands-computing-science-landscape) and the [__Scottish Tech Army__](https://www.scottishtecharmy.org)
    - the outcomes provide a _Landscape of Computing Science_ to support the [Digital Technology Education Charter](https://www.dtecharter.org)
  * provide insight into complex, multi-source, high-dimensional and/or inter-related data, as seen in a summary of changes to active travel data across Scotland [_prior to and during the 2020 and 2021 lockdowns_](sta/cycle_counters_info_cards.pdf). (See also [___the interactive version___](sta/sta-climate-change_cycling))
    - a related visualisation looks at the [_biannual all-modes transportation survey_](sta/sta-climate-change_traffic_surveys) carried out at selected locations in each of Scotland's 32 local authorities. (r code available on request)
...
A couple examples of data models I've built, to feed into visualisation-guided analysis:
  ...
  * [___Scottish Qualifications Authority data &ndash; pupil grades &amp; teacher demographics___](https://raw.githubusercontent.com/aba-sah/sta-it402-dresscode/main/docs/sta-it-402_data_structure.pdf)
